...
$app->post('/api/MicrosoftVideo/generateMotionThumbnail', function ($request, $response) {
    ...
    $optionalParams = ['maxMotionThumbnailDurationInSecs'=>'maxMotionThumbnailDurationInSecs','outputAudio'=>'outputAudio','fadeInFadeOut'=>'fadeInFadeOut'];
    $bodyParams = ['url'];
    ...
    $query_str = "https://westus.api.cognitive.microsoft.com/video/v1.0/generatethumbnail";
